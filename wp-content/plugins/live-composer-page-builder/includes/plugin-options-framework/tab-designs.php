...
<h2 class="dslc-tab-heading">Save your time with <a href="https://livecomposerplugin.com/designs/?utm_source=wp-admin&utm_medium=designs-tab&utm_campaign=section-title" target="_blank">Ready-to-use Designs</a></h2>
...
<div class="extension-browser rendered">
	<div class="extensions wp-clearfix">
		...
		<div class="extension" tabindex="0" >
			...
			<a href="//livecomposerplugin.com/downloads/linecons-icons-add-on/?utm_source=wp-admin&utm_medium=designs-tab&utm_campaign=linecons" target="_blank" class="more-details">More Details</a>

			<h2 class="extension-name"><em>Add-On:</em> Linecons Icons Add-On</h2>
			<div class="extension-actions">
				<a href="//livecomposerplugin.com/downloads/linecons-icons-add-on/?utm_source=wp-admin&utm_medium=designs-tab&utm_campaign=linecons" target="_blank" class="button button-secondary activate">Details</a>
				<a href="//livecomposerplugin.com/downloads/linecons-icons-add-on/?utm_source=wp-admin&utm_medium=designs-tab&utm_campaign=linecons" target="_blank" class="button button-primary load-customize hide-if-no-customize">Download</a>
			</div>
