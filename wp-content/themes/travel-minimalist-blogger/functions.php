<?php 
add_action( 'wp_enqueue_scripts', 'travel_minimalist_blogger_enqueue_styles' );
function travel_minimalist_blogger_enqueue_styles() {
	wp_enqueue_style( 'travel-minimalist-blogger', get_template_directory_uri() . '/style.css' ); 
} 

function travel_minimalistblogger_customize_register( $wp_customize ) {

	$wp_customize->add_section( 'footer_settings', array(
		'title'      => __('Footer Settings','travel-minimalistblogger'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_headline_color', array(
		'label'       => __( 'Headline Color', 'travel-minimalistblogger' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_text_color', array(
		'label'       => __( 'Text Color', 'travel-minimalistblogger' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_link_color', array(
		'label'       => __( 'Link Color', 'travel-minimalistblogger' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_background_color', array(
		'label'       => __( 'Background Color', 'travel-minimalistblogger' ),
		'section'     => 'footer_settings',
		'priority'   => 1,
...
add_action( 'customize_register', 'travel_minimalistblogger_customize_register' );




if(! function_exists('travel_minimalistblogger_customizer_css_final_output' ) ):
	function travel_minimalistblogger_customizer_css_final_output(){
		?>
	...
	<style type="text/css">
		...
		<?php }
		add_action( 'wp_head', 'travel_minimalistblogger_customizer_css_final_output' );
		endif;
