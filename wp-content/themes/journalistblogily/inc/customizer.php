<?php
/**
 * journalistblogily Theme Customizer.
 *
 ...
 */
function journalistblogily_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'navigation_settings',
        array(
            'title' => __('Navigation', 'journalistblogily'),
            'priority' => 99,
            )
        );  
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'nav_bg', array(
        'label'       => __( 'Background Color', 'journalistblogily' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'nav_link_color', array(
        'label'       => __( 'Link Color', 'journalistblogily' ),
        'section'     => 'navigation_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'nav_logo_color', array(
        'label'       => __( 'Logo Color', 'journalistblogily' ),
        'section'     => 'navigation_settings',
        'priority' => 1,
        'settings'    => 'nav_logo_color',
        ) ) );
    $wp_customize->add_control( 'display_header_text', array(
        'label'    => __( 'Header Text Color', 'journalistblogily' ),
        'section'  => 'head_colors',
        ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'background_color', array(
        'label'       => __( 'Background Color', 'journalistblogily' ),
        'description' => __( 'Choose a color for the background.', 'journalistblogily' ),
        'section'     => 'background_image',
        'settings'    => 'background_color',
        ) ) );
    $wp_customize->add_setting( 'show_sitename_in_menubar', array(
        'default'           => 1,
        'sanitize_callback' => 'journalistblogily_sanitize_checkbox',
        ) );
    $wp_customize->add_section(
        'sidebar_settings',
        array(
            'title' => __('Sidebar ', 'journalistblogily'),
            'priority' => 99,
            )
        );  
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_headline', array(
        'label'       => __( 'Headline Color', 'journalistblogily' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_headline_border', array(
        'label'       => __( 'Headline Border Color', 'journalistblogily' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_text', array(
        'label'       => __( 'Text Color', 'journalistblogily' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_button_bg', array(
        'label'       => __( 'Button Background Color', 'journalistblogily' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_button_text_color', array(
        'label'       => __( 'Button Text Color', 'journalistblogily' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            ...
            array( 
                'label'         => __( 'Show sitename in menu bar?', 'journalistblogily' ),
                'type'          => 'checkbox',
    ...
    /* ///////////////// SIDEBAR LAYOUT ////////////////// */
        ...
        $wp_customize->add_section( 'journalistblogily-options', array(
            'title'         => __( 'Theme Options', 'journalistblogily' ),
            'capability'    => 'edit_theme_options',
            'description'   => __( 'Change the default display options for the theme.', 'journalistblogily' ),
            ) );
        ...
        $wp_customize->add_setting( 'layout_setting',
            array(
                ...
                'type'              => 'theme_mod',
                'sanitize_callback' => 'journalistblogily_sanitize_layout',
                'transport'         => 'postMessage'
                ) );
        ...
        $wp_customize->add_control( 'layout_control',
            array(
                ...
                'type'              => 'radio',
                'label'             => __( 'Sidebar position', 'journalistblogily' ),
                'choices'           => array(
                    'no-sidebar'    => __( 'No sidebar', 'journalistblogily' ),
                    'sidebar-right' => __( 'Sidebar right', 'journalistblogily' ),
                    'sidebar-left'  => __( 'Sidebar left', 'journalistblogily' ),
                    ),
                'section'           => 'sidebar_settings'
                ) );
...
//			'transport'         => 'postMessage',
          ...
          $wp_customize->add_control( 'panel_' . $page_names[$i], array(
             ...
             'label'          => sprintf( __( '%s Page Content', 'journalistblogily' ), ucwords( $page_names[$i] ) ),
             'description'    => ( 0 !== $i ? '' : __( 'Select pages to feature in each area from the dropdowns. Add an image to a section by setting a featured image in the page editor. Empty sections will not be displayed.', 'journalistblogily' ) ),
             'section'        => 'static_front_page',
             'type'           => 'dropdown-pages',
             'allow_addition' => true,
             'active_callback' => 'journalistblogily_is_static_front_page',
             ) );

//		$wp_customize->selective_refresh->add_partial( 'panel_' . $page_names[$i], array(
//			'selector'            => '#' . $page_names[$i],
//			'render_callback'     => 'journalistblogily_front_page_section',
//			'container_inclusive' => true,
//		) );
      }

  }
  add_action( 'customize_register', 'journalistblogily_customize_register' );

/**
 * Return whether we're previewing the front page and it's a static page.
 */
function journalistblogily_is_static_front_page() {
 ...
 */
function journalistblogily_customize_preview_js() {
	wp_enqueue_script( 'journalistblogily_customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20160507', true );
}
add_action( 'customize_preview_init', 'journalistblogily_customize_preview_js' );

/*
 * Sanitize layout options
 */

function journalistblogily_sanitize_layout ( $value ) {
 ...
 */
function journalistblogily_sanitize_checkbox( $checked ) {
    // Boolean check
    return ( ( isset( $checked ) && true == $checked ) ? true : false );
}


if(! function_exists('journalistblogily_get_user_input' ) ):
function journalistblogily_get_user_input(){
    ?>
    <style type="text/css">
    ...
    <?php }
    add_action( 'wp_head', 'journalistblogily_get_user_input' );
    endif;
