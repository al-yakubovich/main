<div class="col-sm-3 col-xs-6">
    <?php if (get_previous_post()) { ?>
        <p class="post-navigation-link post-navigation-link--left">
            <a href="<?php esc_attr(the_permalink(get_previous_post()->ID)); ?>"><span class="fa fa-long-arrow-alt-left"></span> <?php esc_html_e('Previous article', 'omtria'); ?></a>
        </p>
...
<div class="col-sm-3 col-xs-6">
    <?php if (get_next_post()) { ?>
        <p class="post-navigation-link post-navigation-link--right">
            <a href="<?php esc_attr(the_permalink(get_next_post()->ID)); ?>"><?php esc_html_e('Next article', 'omtria'); ?> <span class="fa fa-long-arrow-alt-right"></span></a>
        </p>
