jQuery(document).ready(function($){
  ...
  $('#fordummies_update_theme3').click(function(evn){
   ...
   if($('#fordummies_update_theme3').is(':checked'))
    { cval = '1';    }
   else
    { cval = '0';    }
   ...
   $('#fordummies-update-theme2').submit();

  });   
    
     $( "#fordummies-open-help" ).click(function() {
   ...
   $( "#fordummies-send-support" ).click(function(evt) {
       // cliccou no support
       
       // alert(evt.target.id);
       
       
       $modalvma = $('.bill-support-fordummies')
       var activated = $('#activated').val();
       
       if(activated !== '1')
       {
                        $("#fordummies-not-activated").dialog({
                            modal: true,
                            ...
                            buttons: {
                                Ok: function () {
                                    $(this).dialog("close");
                                    location.reload();
                                    /* $("#fordummies-not-activated").remove(); */
                                }
                            }
                        }); //end confirm dialog      
  ...
  $( ".button-close-spsubmit" ).click(function() {
       // submeteu support
                    // var isAnonymousFeedback = $(".anonymous").prop("checked");
                     ...
                     $('#fordummies-imagewait3').css('visibility','visible');
                     ...
                     $.ajax({
                		...
                		complete  : function () {
                             ...
                             // $modalvma = $('.bill-feedback-fordummies')
                              $('#fordummies-imagewait2').css('visibility','hidden');
                              $modalvma.slideUp();
   ...
   /*  Feedback ------ */
   $( "#fordummies-give-feedback" ).click(function(evt) {
       // cliccou no feedback
       
       $modalvmaf = $('.bill-feedback-fordummies');
  ...
  $( ".button-close-fbsubmit" ).click(function() {
       // submeteu feedback
                    ...
                    if(isAnonymousFeedback)
                    {
                     ...
                     $('#fordummies-imagewait2').css('visibility','visible');
  ...
  $("#fordummies-btn-connect-now" ).click(function(evt) {
                     ...
                     $('#fordummies-imagewait').css('visibility','visible');
                     $( "#fordummies-btn-connect-now" ).addClass('disabled');
                     $.ajax({
                	    url       : 'http://billminozzi.com/httpapi/httpapi.php',
                        withCredentials: true,
                        timeout: 15000,
                		...
                		complete  : function () {
                             ...
                             cvalue = "1-"+dom;
                             document.cookie = "bill_activated_vm" + "=" + cvalue + ";" + expires + ";path=/";
                             $('#fordummies-imagewait').css('visibility','hidden');
  ...
  $( ".button-close-faqsubmit" ).click(function() {
       // submeteu faq
                     ...
                     $('#fordummies-imagewait20').css('visibility','hidden');
                    ...
                    if(isAnonymousFeedback)
                    {
                     ...
                     $('#fordummies-imagewait20').css('visibility','visible');
