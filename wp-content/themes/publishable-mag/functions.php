			...
			<div class="container">
				<div class="row" id="copyright-note">
					<span>
						...
						<?php echo esc_html_e(' | WordPress Theme by', 'publishable-mag') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'publishable-mag'); ?>"><?php echo esc_html_e(' Superb Themes', 'publishable-mag') ?></a>
					</span>
					<div class="top">
