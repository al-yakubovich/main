...
// Add class Di_Responsive_Engine, responsible for setup, styles, scripts, sidebar registration.
require_once get_template_directory() . '/inc/core/class-di-responsive-engine.php';
