...
if ( ! class_exists( 'Our_Blog_Demo' ) ) {
	...
	class Our_Blog_Demo {
		...
		/**
		 * Singleton instance of Our_Blog_Demo.
		 *
		 * @var Our_Blog_Demo $instance Our_Blog_Demo instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Our_Blog_Demo ) ) {
				self::$instance = new Our_Blog_Demo();
